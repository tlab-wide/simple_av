...
#ifndef SIMPLE_AV_MSGS__SRV__DETAIL__TRIGGER_MISSION_PLAN__FUNCTIONS_H_
#define SIMPLE_AV_MSGS__SRV__DETAIL__TRIGGER_MISSION_PLAN__FUNCTIONS_H_
...
#include "simple_av_msgs/srv/detail/trigger_mission_plan__struct.h"

/// Initialize srv/TriggerMissionPlan message.
/**
...
/// Finalize srv/TriggerMissionPlan message.
/**
...
/// Create srv/TriggerMissionPlan message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * simple_av_msgs__srv__TriggerMissionPlan_Request__init().
...
/// Destroy srv/TriggerMissionPlan message.
/**
 * It calls
 * simple_av_msgs__srv__TriggerMissionPlan_Request__fini()
...
/// Check for srv/TriggerMissionPlan message equality.
/**
...
/// Copy a srv/TriggerMissionPlan message.
/**
...
/// Initialize array of srv/TriggerMissionPlan messages.
/**
...
/// Finalize array of srv/TriggerMissionPlan messages.
/**
 * It calls
 * simple_av_msgs__srv__TriggerMissionPlan_Request__fini()
...
/// Create array of srv/TriggerMissionPlan messages.
/**
 * It allocates the memory for the array and calls
 * simple_av_msgs__srv__TriggerMissionPlan_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/TriggerMissionPlan messages.
/**
 * It calls
 * simple_av_msgs__srv__TriggerMissionPlan_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/TriggerMissionPlan message array equality.
/**
...
/// Copy an array of srv/TriggerMissionPlan messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * simple_av_msgs__srv__TriggerMissionPlan_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_simple_av_msgs
...
/**
 * It calls
 * simple_av_msgs__srv__TriggerMissionPlan_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_simple_av_msgs
...
/**
 * It allocates the memory for the array and calls
 * simple_av_msgs__srv__TriggerMissionPlan_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_simple_av_msgs
...
/**
 * It calls
 * simple_av_msgs__srv__TriggerMissionPlan_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // SIMPLE_AV_MSGS__SRV__DETAIL__TRIGGER_MISSION_PLAN__FUNCTIONS_H_
