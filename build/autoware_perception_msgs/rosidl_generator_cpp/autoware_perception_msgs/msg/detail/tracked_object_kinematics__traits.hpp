...
#ifndef AUTOWARE_PERCEPTION_MSGS__MSG__DETAIL__TRACKED_OBJECT_KINEMATICS__TRAITS_HPP_
#define AUTOWARE_PERCEPTION_MSGS__MSG__DETAIL__TRACKED_OBJECT_KINEMATICS__TRAITS_HPP_
...
inline void to_yaml(
  const autoware_perception_msgs::msg::TrackedObjectKinematics & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const autoware_perception_msgs::msg::TrackedObjectKinematics & msg)
{
  return autoware_perception_msgs::msg::to_yaml(msg);
}

template<>
inline const char * data_type<autoware_perception_msgs::msg::TrackedObjectKinematics>()
{
  return "autoware_perception_msgs::msg::TrackedObjectKinematics";
}

template<>
inline const char * name<autoware_perception_msgs::msg::TrackedObjectKinematics>()
{
  return "autoware_perception_msgs/msg/TrackedObjectKinematics";
}

template<>
struct has_fixed_size<autoware_perception_msgs::msg::TrackedObjectKinematics>
...
template<>
struct has_bounded_size<autoware_perception_msgs::msg::TrackedObjectKinematics>
...
template<>
struct is_message<autoware_perception_msgs::msg::TrackedObjectKinematics>
  : std::true_type {};

}  // namespace rosidl_generator_traits

#endif  // AUTOWARE_PERCEPTION_MSGS__MSG__DETAIL__TRACKED_OBJECT_KINEMATICS__TRAITS_HPP_
