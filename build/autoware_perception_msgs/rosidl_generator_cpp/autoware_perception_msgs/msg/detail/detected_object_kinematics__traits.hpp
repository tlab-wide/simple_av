...
#ifndef AUTOWARE_PERCEPTION_MSGS__MSG__DETAIL__DETECTED_OBJECT_KINEMATICS__TRAITS_HPP_
#define AUTOWARE_PERCEPTION_MSGS__MSG__DETAIL__DETECTED_OBJECT_KINEMATICS__TRAITS_HPP_
...
inline void to_yaml(
  const autoware_perception_msgs::msg::DetectedObjectKinematics & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const autoware_perception_msgs::msg::DetectedObjectKinematics & msg)
{
  return autoware_perception_msgs::msg::to_yaml(msg);
}

template<>
inline const char * data_type<autoware_perception_msgs::msg::DetectedObjectKinematics>()
{
  return "autoware_perception_msgs::msg::DetectedObjectKinematics";
}

template<>
inline const char * name<autoware_perception_msgs::msg::DetectedObjectKinematics>()
{
  return "autoware_perception_msgs/msg/DetectedObjectKinematics";
}

template<>
struct has_fixed_size<autoware_perception_msgs::msg::DetectedObjectKinematics>
...
template<>
struct has_bounded_size<autoware_perception_msgs::msg::DetectedObjectKinematics>
...
template<>
struct is_message<autoware_perception_msgs::msg::DetectedObjectKinematics>
  : std::true_type {};

}  // namespace rosidl_generator_traits

#endif  // AUTOWARE_PERCEPTION_MSGS__MSG__DETAIL__DETECTED_OBJECT_KINEMATICS__TRAITS_HPP_
