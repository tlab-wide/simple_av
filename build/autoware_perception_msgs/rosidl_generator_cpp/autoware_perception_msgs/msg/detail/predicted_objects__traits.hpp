...
inline std::string to_yaml(const PredictedObjects & msg, bool use_flow_style = false)
{
...
inline std::string to_yaml(const autoware_perception_msgs::msg::PredictedObjects & msg)
{
