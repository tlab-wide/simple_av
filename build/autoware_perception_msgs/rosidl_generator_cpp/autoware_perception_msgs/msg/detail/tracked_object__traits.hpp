...
#ifndef AUTOWARE_PERCEPTION_MSGS__MSG__DETAIL__TRACKED_OBJECT__TRAITS_HPP_
#define AUTOWARE_PERCEPTION_MSGS__MSG__DETAIL__TRACKED_OBJECT__TRAITS_HPP_
...
// Member 'kinematics'
#include "autoware_perception_msgs/msg/detail/tracked_object_kinematics__traits.hpp"
// Member 'shape'
...
inline void to_yaml(
  const autoware_perception_msgs::msg::TrackedObject & msg,
  std::ostream & out, size_t indentation = 0)
{
...
inline std::string to_yaml(const autoware_perception_msgs::msg::TrackedObject & msg)
{
  return autoware_perception_msgs::msg::to_yaml(msg);
}

template<>
inline const char * data_type<autoware_perception_msgs::msg::TrackedObject>()
{
  return "autoware_perception_msgs::msg::TrackedObject";
}

template<>
inline const char * name<autoware_perception_msgs::msg::TrackedObject>()
{
  return "autoware_perception_msgs/msg/TrackedObject";
}

template<>
struct has_fixed_size<autoware_perception_msgs::msg::TrackedObject>
  : std::integral_constant<bool, false> {};

template<>
struct has_bounded_size<autoware_perception_msgs::msg::TrackedObject>
  : std::integral_constant<bool, false> {};

template<>
struct is_message<autoware_perception_msgs::msg::TrackedObject>
  : std::true_type {};

}  // namespace rosidl_generator_traits

#endif  // AUTOWARE_PERCEPTION_MSGS__MSG__DETAIL__TRACKED_OBJECT__TRAITS_HPP_
