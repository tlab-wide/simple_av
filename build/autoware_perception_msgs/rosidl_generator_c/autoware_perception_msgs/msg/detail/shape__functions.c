...
bool
autoware_perception_msgs__msg__Shape__are_equal(const autoware_perception_msgs__msg__Shape * lhs, const autoware_perception_msgs__msg__Shape * rhs)
{
  if (!lhs || !rhs) {
    return false;
  }
...
bool
autoware_perception_msgs__msg__Shape__copy(
  const autoware_perception_msgs__msg__Shape * input,
  autoware_perception_msgs__msg__Shape * output)
{
  if (!input || !output) {
    return false;
  }
...
autoware_perception_msgs__msg__Shape__create()
{
  ...
  autoware_perception_msgs__msg__Shape * msg = (autoware_perception_msgs__msg__Shape *)allocator.allocate(sizeof(autoware_perception_msgs__msg__Shape), allocator.state);
  if (!msg) {
    return NULL;
  }
...
autoware_perception_msgs__msg__Shape__Sequence__init(autoware_perception_msgs__msg__Shape__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (autoware_perception_msgs__msg__Shape *)allocator.zero_allocate(size, sizeof(autoware_perception_msgs__msg__Shape), allocator.state);
    if (!data) {
      return false;
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  autoware_perception_msgs__msg__Shape__Sequence * array = (autoware_perception_msgs__msg__Shape__Sequence *)allocator.allocate(sizeof(autoware_perception_msgs__msg__Shape__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
...
bool
autoware_perception_msgs__msg__Shape__Sequence__are_equal(const autoware_perception_msgs__msg__Shape__Sequence * lhs, const autoware_perception_msgs__msg__Shape__Sequence * rhs)
{
  if (!lhs || !rhs) {
    return false;
  }
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!autoware_perception_msgs__msg__Shape__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
...
bool
autoware_perception_msgs__msg__Shape__Sequence__copy(
  const autoware_perception_msgs__msg__Shape__Sequence * input,
  autoware_perception_msgs__msg__Shape__Sequence * output)
{
  if (!input || !output) {
    return false;
  }
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(autoware_perception_msgs__msg__Shape);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    autoware_perception_msgs__msg__Shape * data =
      (autoware_perception_msgs__msg__Shape *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!autoware_perception_msgs__msg__Shape__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          autoware_perception_msgs__msg__Shape__fini(&output->data[i]);
        }
        return false;
      }
    }
