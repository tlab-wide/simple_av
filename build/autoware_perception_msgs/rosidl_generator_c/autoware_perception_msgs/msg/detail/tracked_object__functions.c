...
autoware_perception_msgs__msg__TrackedObject__init(autoware_perception_msgs__msg__TrackedObject * msg)
{
  ...
  if (!unique_identifier_msgs__msg__UUID__init(&msg->object_id)) {
    autoware_perception_msgs__msg__TrackedObject__fini(msg);
    return false;
  }
  ...
  // kinematics
  if (!autoware_perception_msgs__msg__TrackedObjectKinematics__init(&msg->kinematics)) {
    autoware_perception_msgs__msg__TrackedObject__fini(msg);
    return false;
  }
  // shape
...
autoware_perception_msgs__msg__TrackedObject__fini(autoware_perception_msgs__msg__TrackedObject * msg)
{
  ...
  // kinematics
  autoware_perception_msgs__msg__TrackedObjectKinematics__fini(&msg->kinematics);
  // shape
...
autoware_perception_msgs__msg__TrackedObject__are_equal(const autoware_perception_msgs__msg__TrackedObject * lhs, const autoware_perception_msgs__msg__TrackedObject * rhs)
{
  ...
  // kinematics
  if (!autoware_perception_msgs__msg__TrackedObjectKinematics__are_equal(
  ...
  autoware_perception_msgs__msg__TrackedObject * output)
{
  ...
  // kinematics
  if (!autoware_perception_msgs__msg__TrackedObjectKinematics__copy(
...
autoware_perception_msgs__msg__TrackedObject__create()
{
  ...
  autoware_perception_msgs__msg__TrackedObject * msg = (autoware_perception_msgs__msg__TrackedObject *)allocator.allocate(sizeof(autoware_perception_msgs__msg__TrackedObject), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(autoware_perception_msgs__msg__TrackedObject));
  bool success = autoware_perception_msgs__msg__TrackedObject__init(msg);
  if (!success) {
...
autoware_perception_msgs__msg__TrackedObject__Sequence__init(autoware_perception_msgs__msg__TrackedObject__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  autoware_perception_msgs__msg__TrackedObject * data = NULL;

  if (size) {
    data = (autoware_perception_msgs__msg__TrackedObject *)allocator.zero_allocate(size, sizeof(autoware_perception_msgs__msg__TrackedObject), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = autoware_perception_msgs__msg__TrackedObject__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        autoware_perception_msgs__msg__TrackedObject__fini(&data[i - 1]);
      }
...
autoware_perception_msgs__msg__TrackedObject__Sequence__fini(autoware_perception_msgs__msg__TrackedObject__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      autoware_perception_msgs__msg__TrackedObject__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  autoware_perception_msgs__msg__TrackedObject__Sequence * array = (autoware_perception_msgs__msg__TrackedObject__Sequence *)allocator.allocate(sizeof(autoware_perception_msgs__msg__TrackedObject__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = autoware_perception_msgs__msg__TrackedObject__Sequence__init(array, size);
  if (!success) {
...
autoware_perception_msgs__msg__TrackedObject__Sequence__destroy(autoware_perception_msgs__msg__TrackedObject__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    autoware_perception_msgs__msg__TrackedObject__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
autoware_perception_msgs__msg__TrackedObject__Sequence__are_equal(const autoware_perception_msgs__msg__TrackedObject__Sequence * lhs, const autoware_perception_msgs__msg__TrackedObject__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!autoware_perception_msgs__msg__TrackedObject__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  autoware_perception_msgs__msg__TrackedObject__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(autoware_perception_msgs__msg__TrackedObject);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    autoware_perception_msgs__msg__TrackedObject * data =
      (autoware_perception_msgs__msg__TrackedObject *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!autoware_perception_msgs__msg__TrackedObject__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          autoware_perception_msgs__msg__TrackedObject__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!autoware_perception_msgs__msg__TrackedObject__copy(
