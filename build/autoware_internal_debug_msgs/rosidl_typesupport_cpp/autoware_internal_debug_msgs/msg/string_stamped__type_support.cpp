...
static const _StringStamped_type_support_symbol_names_t _StringStamped_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, autoware_internal_debug_msgs, msg, StringStamped)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, autoware_internal_debug_msgs, msg, StringStamped)),
  }
};
...
{
  return &::autoware_internal_debug_msgs::msg::rosidl_typesupport_cpp::StringStamped_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, autoware_internal_debug_msgs, msg, StringStamped)() {
  return get_message_type_support_handle<autoware_internal_debug_msgs::msg::StringStamped>();
}
