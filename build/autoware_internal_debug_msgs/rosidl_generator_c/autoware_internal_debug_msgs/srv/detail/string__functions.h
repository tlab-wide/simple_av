...
#ifndef AUTOWARE_INTERNAL_DEBUG_MSGS__SRV__DETAIL__STRING__FUNCTIONS_H_
#define AUTOWARE_INTERNAL_DEBUG_MSGS__SRV__DETAIL__STRING__FUNCTIONS_H_
 ...
 * calls
 * autoware_internal_debug_msgs__srv__String_Request__init().
...
/**
 * It calls
 * autoware_internal_debug_msgs__srv__String_Request__fini()
 ...
 * autoware_internal_debug_msgs__srv__String_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/**
 * It calls
 * autoware_internal_debug_msgs__srv__String_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * autoware_internal_debug_msgs__srv__String_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_autoware_internal_debug_msgs
...
/**
 * It calls
 * autoware_internal_debug_msgs__srv__String_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_autoware_internal_debug_msgs
...
/**
 * It allocates the memory for the array and calls
 * autoware_internal_debug_msgs__srv__String_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_autoware_internal_debug_msgs
...
/**
 * It calls
 * autoware_internal_debug_msgs__srv__String_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // AUTOWARE_INTERNAL_DEBUG_MSGS__SRV__DETAIL__STRING__FUNCTIONS_H_
