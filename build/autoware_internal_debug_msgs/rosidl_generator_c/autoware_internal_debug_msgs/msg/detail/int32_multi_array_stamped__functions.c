...
autoware_internal_debug_msgs__msg__Int32MultiArrayStamped__init(autoware_internal_debug_msgs__msg__Int32MultiArrayStamped * msg)
{
  ...
  if (!builtin_interfaces__msg__Time__init(&msg->stamp)) {
    autoware_internal_debug_msgs__msg__Int32MultiArrayStamped__fini(msg);
    return false;
  }
  // layout
...
autoware_internal_debug_msgs__msg__Int32MultiArrayStamped__create()
{
  ...
  autoware_internal_debug_msgs__msg__Int32MultiArrayStamped * msg = (autoware_internal_debug_msgs__msg__Int32MultiArrayStamped *)allocator.allocate(sizeof(autoware_internal_debug_msgs__msg__Int32MultiArrayStamped), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(autoware_internal_debug_msgs__msg__Int32MultiArrayStamped));
  bool success = autoware_internal_debug_msgs__msg__Int32MultiArrayStamped__init(msg);
  if (!success) {
...
autoware_internal_debug_msgs__msg__Int32MultiArrayStamped__Sequence__init(autoware_internal_debug_msgs__msg__Int32MultiArrayStamped__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  autoware_internal_debug_msgs__msg__Int32MultiArrayStamped * data = NULL;

  if (size) {
    data = (autoware_internal_debug_msgs__msg__Int32MultiArrayStamped *)allocator.zero_allocate(size, sizeof(autoware_internal_debug_msgs__msg__Int32MultiArrayStamped), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = autoware_internal_debug_msgs__msg__Int32MultiArrayStamped__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        autoware_internal_debug_msgs__msg__Int32MultiArrayStamped__fini(&data[i - 1]);
      }
...
autoware_internal_debug_msgs__msg__Int32MultiArrayStamped__Sequence__fini(autoware_internal_debug_msgs__msg__Int32MultiArrayStamped__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      autoware_internal_debug_msgs__msg__Int32MultiArrayStamped__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  autoware_internal_debug_msgs__msg__Int32MultiArrayStamped__Sequence * array = (autoware_internal_debug_msgs__msg__Int32MultiArrayStamped__Sequence *)allocator.allocate(sizeof(autoware_internal_debug_msgs__msg__Int32MultiArrayStamped__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = autoware_internal_debug_msgs__msg__Int32MultiArrayStamped__Sequence__init(array, size);
  if (!success) {
...
autoware_internal_debug_msgs__msg__Int32MultiArrayStamped__Sequence__destroy(autoware_internal_debug_msgs__msg__Int32MultiArrayStamped__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    autoware_internal_debug_msgs__msg__Int32MultiArrayStamped__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
autoware_internal_debug_msgs__msg__Int32MultiArrayStamped__Sequence__are_equal(const autoware_internal_debug_msgs__msg__Int32MultiArrayStamped__Sequence * lhs, const autoware_internal_debug_msgs__msg__Int32MultiArrayStamped__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!autoware_internal_debug_msgs__msg__Int32MultiArrayStamped__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  autoware_internal_debug_msgs__msg__Int32MultiArrayStamped__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(autoware_internal_debug_msgs__msg__Int32MultiArrayStamped);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    autoware_internal_debug_msgs__msg__Int32MultiArrayStamped * data =
      (autoware_internal_debug_msgs__msg__Int32MultiArrayStamped *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!autoware_internal_debug_msgs__msg__Int32MultiArrayStamped__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          autoware_internal_debug_msgs__msg__Int32MultiArrayStamped__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!autoware_internal_debug_msgs__msg__Int32MultiArrayStamped__copy(
