...
bool autoware_internal_metric_msgs__msg__metric__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("autoware_internal_metric_msgs.msg._metric.Metric", full_classname_dest, 48) == 0);
  }
  autoware_internal_metric_msgs__msg__Metric * ros_message = _ros_message;
  {  // name
...
PyObject * autoware_internal_metric_msgs__msg__metric__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("autoware_internal_metric_msgs.msg._metric");
