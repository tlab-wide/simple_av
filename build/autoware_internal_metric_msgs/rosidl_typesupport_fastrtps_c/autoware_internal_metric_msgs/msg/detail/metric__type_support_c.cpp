...
#include "autoware_internal_metric_msgs/msg/detail/metric__rosidl_typesupport_fastrtps_c.h"
...
#include "rosidl_runtime_c/string.h"  // name, unit, value
#include "rosidl_runtime_c/string_functions.h"  // name, unit, value

// forward declare type support functions


using _Metric__ros_msg_type = autoware_internal_metric_msgs__msg__Metric;
...
static uint32_t _Metric__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_autoware_internal_metric_msgs__msg__Metric(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = autoware_internal_metric_msgs__msg__Metric;
    is_plain =
      (
...
static size_t _Metric__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_autoware_internal_metric_msgs__msg__Metric(
