...
#include "autoware_system_msgs/msg/detail/autoware_state__rosidl_typesupport_fastrtps_c.h"
...
using _AutowareState__ros_msg_type = autoware_system_msgs__msg__AutowareState;
...
size_t get_serialized_size_autoware_system_msgs__msg__AutowareState(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _AutowareState__ros_msg_type * ros_message = static_cast<const _AutowareState__ros_msg_type *>(untyped_ros_message);
...
static uint32_t _AutowareState__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_autoware_system_msgs__msg__AutowareState(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_autoware_system_msgs
size_t max_serialized_size_autoware_system_msgs__msg__AutowareState(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = autoware_system_msgs__msg__AutowareState;
    is_plain =
      (
...
static size_t _AutowareState__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_autoware_system_msgs__msg__AutowareState(
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, autoware_system_msgs, msg, AutowareState)() {
