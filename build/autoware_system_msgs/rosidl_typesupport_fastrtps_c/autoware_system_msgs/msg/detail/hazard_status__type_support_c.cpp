...
#include "autoware_system_msgs/msg/detail/hazard_status__rosidl_typesupport_fastrtps_c.h"
...
using _HazardStatus__ros_msg_type = autoware_system_msgs__msg__HazardStatus;
...
static uint32_t _HazardStatus__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_autoware_system_msgs__msg__HazardStatus(
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = autoware_system_msgs__msg__HazardStatus;
    is_plain =
      (
...
static size_t _HazardStatus__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_autoware_system_msgs__msg__HazardStatus(
