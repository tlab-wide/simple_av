...
#include "autoware_system_msgs/msg/detail/autoware_state__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const autoware_system_msgs::msg::AutowareState & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  autoware_system_msgs::msg::AutowareState & ros_message)
{
  // Member: stamp
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = autoware_system_msgs::msg::AutowareState;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const autoware_system_msgs::msg::AutowareState *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<autoware_system_msgs::msg::AutowareState *>(
    untyped_ros_message);
...
{
  return &autoware_system_msgs::msg::typesupport_fastrtps_cpp::_AutowareState__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, autoware_system_msgs, msg, AutowareState)() {
  return &autoware_system_msgs::msg::typesupport_fastrtps_cpp::_AutowareState__handle;
}
