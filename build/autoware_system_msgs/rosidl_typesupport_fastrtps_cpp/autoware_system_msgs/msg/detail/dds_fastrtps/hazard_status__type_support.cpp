...
#include "autoware_system_msgs/msg/detail/hazard_status__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const autoware_system_msgs::msg::HazardStatus & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  autoware_system_msgs::msg::HazardStatus & ros_message)
{
  // Member: level
  cdr >> ros_message.level;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = autoware_system_msgs::msg::HazardStatus;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const autoware_system_msgs::msg::HazardStatus *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<autoware_system_msgs::msg::HazardStatus *>(
    untyped_ros_message);
...
{
  return &autoware_system_msgs::msg::typesupport_fastrtps_cpp::_HazardStatus__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, autoware_system_msgs, msg, HazardStatus)() {
  return &autoware_system_msgs::msg::typesupport_fastrtps_cpp::_HazardStatus__handle;
}
