...
public:
  ...
  {}
  Init_HazardStatusStamped_status stamp(::autoware_system_msgs::msg::HazardStatusStamped::_stamp_type arg)
  {
...
{
  return autoware_system_msgs::msg::builder::Init_HazardStatusStamped_stamp();
}
