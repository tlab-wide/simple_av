...
bool
autoware_system_msgs__msg__AutowareState__are_equal(const autoware_system_msgs__msg__AutowareState * lhs, const autoware_system_msgs__msg__AutowareState * rhs)
{
  if (!lhs || !rhs) {
    return false;
  }
...
bool
autoware_system_msgs__msg__AutowareState__copy(
  const autoware_system_msgs__msg__AutowareState * input,
  autoware_system_msgs__msg__AutowareState * output)
{
  if (!input || !output) {
    return false;
  }
...
autoware_system_msgs__msg__AutowareState__create()
{
  ...
  autoware_system_msgs__msg__AutowareState * msg = (autoware_system_msgs__msg__AutowareState *)allocator.allocate(sizeof(autoware_system_msgs__msg__AutowareState), allocator.state);
  if (!msg) {
    return NULL;
  }
...
autoware_system_msgs__msg__AutowareState__Sequence__init(autoware_system_msgs__msg__AutowareState__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (autoware_system_msgs__msg__AutowareState *)allocator.zero_allocate(size, sizeof(autoware_system_msgs__msg__AutowareState), allocator.state);
    if (!data) {
      return false;
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  autoware_system_msgs__msg__AutowareState__Sequence * array = (autoware_system_msgs__msg__AutowareState__Sequence *)allocator.allocate(sizeof(autoware_system_msgs__msg__AutowareState__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
...
bool
autoware_system_msgs__msg__AutowareState__Sequence__are_equal(const autoware_system_msgs__msg__AutowareState__Sequence * lhs, const autoware_system_msgs__msg__AutowareState__Sequence * rhs)
{
  if (!lhs || !rhs) {
    return false;
  }
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!autoware_system_msgs__msg__AutowareState__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
...
bool
autoware_system_msgs__msg__AutowareState__Sequence__copy(
  const autoware_system_msgs__msg__AutowareState__Sequence * input,
  autoware_system_msgs__msg__AutowareState__Sequence * output)
{
  if (!input || !output) {
    return false;
  }
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(autoware_system_msgs__msg__AutowareState);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    autoware_system_msgs__msg__AutowareState * data =
      (autoware_system_msgs__msg__AutowareState *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!autoware_system_msgs__msg__AutowareState__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          autoware_system_msgs__msg__AutowareState__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!autoware_system_msgs__msg__AutowareState__copy(
