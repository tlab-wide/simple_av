...
autoware_system_msgs__msg__HazardStatus__create()
{
  ...
  autoware_system_msgs__msg__HazardStatus * msg = (autoware_system_msgs__msg__HazardStatus *)allocator.allocate(sizeof(autoware_system_msgs__msg__HazardStatus), allocator.state);
  if (!msg) {
    return NULL;
  }
...
autoware_system_msgs__msg__HazardStatus__Sequence__init(autoware_system_msgs__msg__HazardStatus__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (autoware_system_msgs__msg__HazardStatus *)allocator.zero_allocate(size, sizeof(autoware_system_msgs__msg__HazardStatus), allocator.state);
    if (!data) {
      return false;
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  autoware_system_msgs__msg__HazardStatus__Sequence * array = (autoware_system_msgs__msg__HazardStatus__Sequence *)allocator.allocate(sizeof(autoware_system_msgs__msg__HazardStatus__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
...
autoware_system_msgs__msg__HazardStatus__Sequence__are_equal(const autoware_system_msgs__msg__HazardStatus__Sequence * lhs, const autoware_system_msgs__msg__HazardStatus__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!autoware_system_msgs__msg__HazardStatus__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  autoware_system_msgs__msg__HazardStatus__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(autoware_system_msgs__msg__HazardStatus);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    autoware_system_msgs__msg__HazardStatus * data =
      (autoware_system_msgs__msg__HazardStatus *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!autoware_system_msgs__msg__HazardStatus__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          autoware_system_msgs__msg__HazardStatus__fini(&output->data[i]);
        }
        return false;
      }
    }
